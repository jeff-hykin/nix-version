...
const allPackagePaths = await FileSystem.listFolderPathsIn(`scan/packages`)
for (const eachPath of allPackagePaths) {
    const packageName = FileSystem.basename(allPackagePaths)
    // FIXME: create a repo
